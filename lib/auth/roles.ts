...
export const SEEDED_ROLES: ReadonlyArray<{
  ...
  { key: ROLE.EMPLOYEE, label: "Employee", description: "Delivery staff. Added from the Candidate Pool, never from Administration → People.", isSuperAdmin: false, rank: 50, viaCandidatePool: true },
];
