...
export const LETTER_TEMPLATES: ReadonlyArray<LetterTemplate> = [
  {
    ...
    intro: "Dear {first}, we are delighted to confirm your engagement with QONIC consulting. This letter sets out the principal terms of your employment. Please review it carefully and confirm your acceptance in the staff portal.",
  ...
  },
  {
    ...
    intro: "Dear {first}, following our recent conversations we are pleased to offer you the position described below at QONIC consulting. We were impressed by your experience and would be glad to welcome you to the team.",
  ...
  },
  {
    ...
    intro: "Dear {first}, in recognition of your contribution to QONIC consulting we are pleased to confirm the following revision to your terms, effective from the date shown below.",
  ...
  },
  {
    ...
    intro: "To whom it may concern — this is to certify that {first} was employed by QONIC consulting in the capacity set out below, and that the details recorded here are accurate according to our records.",
  ...
  },
  {
    ...
    intro: "Dear {first}, this letter confirms that you have been relieved of your duties at QONIC consulting with effect from the date shown below, and that you have completed the handover required of you.",
  ...
  },
  {
    ...
    intro: "Dear {first}, as part of your engagement with QONIC consulting you will have access to confidential information belonging to the firm and to its clients. This undertaking records the obligations that apply to that access.",
