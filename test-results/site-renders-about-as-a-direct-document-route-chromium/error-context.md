...
- Name: site.spec.ts >> renders /about as a direct document route
...
Received string:  "About Us | Avenstrix Consulting"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    14 × unexpected value "About Us | Avenstrix Consulting"
...
- main:
  ...
  - heading "Recruitment excellence, built on genuine partnership." [level=1]
  - paragraph: For more than 15 years, Avenstrix Consulting has connected high-impact organizations with the people who help them grow.
  - paragraph: Our Approach
  - heading "People-first. Results-driven." [level=1]
  - paragraph: We pair deep market knowledge with a human approach. Our consultants listen carefully, challenge thoughtfully, and make introductions that create enduring value.
  - heading "What clients count on" [level=2]
  - list:
    - listitem: ✓ Specialist recruiters who know your market
    - listitem: ✓ Rigorous, considered candidate evaluation
    - listitem: ✓ Clear communication from brief through onboarding
    - listitem: ✓ Partnerships designed to last
  - heading "Let's build what's next." [level=2]
  - link "Work with us":
    - /url: /contact
- contentinfo:
