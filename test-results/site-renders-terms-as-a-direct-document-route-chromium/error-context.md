...
- Name: site.spec.ts >> renders /terms as a direct document route
...
Received string:  "Terms of Service | Avenstrix Consulting"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    13 × unexpected value "Terms of Service | Avenstrix Consulting"
...
- main:
  ...
  - article:
    ...
    - heading "Website use" [level=2]
    - paragraph: This website provides general information about Avenstrix Consulting and its services. Content is provided for informational purposes and may change without notice.
    - heading "Recruitment services" [level=2]
    - paragraph: Submitting an enquiry does not create a recruitment engagement or guarantee a placement. Any engagement is governed by separately agreed terms.
