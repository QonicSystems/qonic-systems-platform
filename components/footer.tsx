...
export function Footer() {
  return <footer className="site-footer">
    <div className="site-container grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-4">
      <div><a href="/" className="brand"><BrandLockup stacked /></a><p className="mt-6 max-w-xs text-sm leading-7">Connecting talent with visionary organizations and building lasting impact.</p></div>
