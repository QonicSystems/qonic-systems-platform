...
export function Footer() {
  return <footer className="bg-navy-dark text-slate-400">
    <div className="site-container grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-4">
      <div><a href="/" className="brand brand--footer"><span className="brand-mark"><LogoMark /></span><span>Avenstrix<span>Consulting</span></span></a><p className="mt-6 max-w-xs text-sm leading-7">Connecting talent with visionary organizations and building lasting impact.</p></div>
    ...
    <div className="border-t border-white/10"><div className="site-container flex flex-col justify-between gap-4 py-6 text-sm sm:flex-row"><span>© {new Date().getFullYear()} {site.name}. All Rights Reserved.</span><span className="flex gap-5"><a className="footer-link" href="/privacy">Privacy Policy</a><a className="footer-link" href="/terms">Terms of Service</a></span></div></div>
  </footer>;
}
