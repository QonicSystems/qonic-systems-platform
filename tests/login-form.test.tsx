...
describe("LoginForm", () => {
  ...
  it("posts the credentials and follows the server's redirect", async () => {
    ...
    render(<LoginForm />);
    await userEvent.type(screen.getByLabelText(/work email/i), "hr@avenstrix.com");
    ...
    expect(JSON.parse(options.body)).toMatchObject({ email: "hr@avenstrix.com", password: "Demo-Passw0rd" });
